...
RSpec.describe User, type: :model do
  describe "Validations" do
    subject { described_class.new(first_name: "John", last_name: "Doe", email: "test@test.com", password: "qwerty", password_confirmation: "qwerty") }
  ...
  describe ".authenticate_with_credentials" do
    ...
    it "is still able to authenticate with whitespaces in the email" do
      subject.save
      expect(User.authenticate_with_credentials(" test@test.com ", "qwerty")).not_to be_nil
    end
